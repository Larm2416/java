// Trabajando numeros enteros 

public class _p16_trabajando_enteros {
    public static void main(String[] args) {
        ...
        System.out.println(String.format("num2 base hexadecimal : %x",num1));
        System.out.println(String.format("La ganancia con cosas : %,d", ganancia));
